...
CELERY_BEAT_SCHEDULE = {
    "publish-scheduled-events": {
        "task": "event_manager.tasks.publish_scheduled_events",
        "schedule": crontab(minute="*"),
    },
    "refresh-weather": {
        "task": "event_manager.tasks.refresh_weather",
...
SPECTACULAR_SETTINGS = {
    ...
    "DESCRIPTION": "API для управления мероприятиями, местами и погодой",
    "VERSION": "1.0.0",
}
